...
import com.tinywo.tinytv.bean.IJKCode
import com.tinywo.tinytv.constant.IntentKey
import com.tinywo.tinytv.databinding.ActivitySettingBinding
...
import com.tinywo.tinytv.dialog.BackupDialog
import com.tinywo.tinytv.dialog.LiveApiDialog
import com.tinywo.tinytv.dialog.SelectDialog
import com.tinywo.tinytv.util.FastClickCheckUtil
import com.tinywo.tinytv.util.FileUtils
import com.tinywo.tinytv.util.HawkConfig
import com.tinywo.tinytv.util.HistoryHelper
...
class SettingActivity : BaseVbActivity<ActivitySettingBinding>() {
    ...
    override fun init() {
        ...
        mBinding.llBackgroundPlay.setOnClickListener {
        ...
        mBinding.llDns.setOnClickListener {
            FastClickCheckUtil.check(it)
            ...
            dialog.setAdapter(object : SelectDialogInterface<String?> {
                override fun click(value: String?, pos: Int) {
                    ...
                    val httpUrl: okhttp3.HttpUrl? = if (url.isEmpty()) null else com.tinywo.tinytv.util.HttpUrlUtil.parse(url)
        ...
        mBinding.llMediaCodec.setOnClickListener {
        ...
        mBinding.llScale.setOnClickListener {
            FastClickCheckUtil.check(it)
        ...
        mBinding.llRender.setOnClickListener {
            FastClickCheckUtil.check(it)
        ...
        mBinding.llHomeRec.setOnClickListener {
            FastClickCheckUtil.check(it)
        ...
        mBinding.llHistoryNum.setOnClickListener {
            FastClickCheckUtil.check(it)
        ...
        // toggle purify video -------------------------------------
        mBinding.llVideoPurify.setOnClickListener {
            FastClickCheckUtil.check(it)
        ...
        mBinding.llIjkCachePlay.setOnClickListener {
            FastClickCheckUtil.check(it)
