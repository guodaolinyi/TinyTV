...
import com.tinywo.tinytv.databinding.ActivityCollectBinding
import com.tinywo.tinytv.adapter.CollectAdapter
...
class CollectActivity : BaseVbActivity<ActivityCollectBinding>() {
    ...
    private fun initView() {
        ...
        mBinding.mGridView.setLayoutManager(GridLayoutManager(this, 4))
