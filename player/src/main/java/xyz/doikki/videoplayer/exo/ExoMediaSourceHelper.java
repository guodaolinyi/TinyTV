...
public final class ExoMediaSourceHelper {
    ...
    public MediaSource getMediaSource(String uri, Map<String, String> headers, boolean isCache, int errorCode) {
        ...
        if (errorCode == PlaybackException.ERROR_CODE_PARSING_CONTAINER_UNSUPPORTED) {
            ...
            return new ProgressiveMediaSource.Factory(getDataSourceFactory(), getExtractorsFactory()).createMediaSource(getMediaItem(uri, errorCode));
        }
        return new ProgressiveMediaSource.Factory(factory, getExtractorsFactory()).createMediaSource(MediaItem.fromUri(contentUri));
    }
